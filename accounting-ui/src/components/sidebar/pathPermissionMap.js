...
const PATH_PERMISSIONS = {
  ...
  "/reports/books/journal": ["REPORTS.FINANCIAL", "VIEW"],
  "/reports/books/income": ["REPORTS.FINANCIAL", "VIEW"],
  "/reports/books/cash-receipt": ["REPORTS.FINANCIAL", "VIEW"],
  "/reports/books/cash-disbursement": ["REPORTS.FINANCIAL", "VIEW"],
  "/reports/books/accounts-payable": ["REPORTS.FINANCIAL", "VIEW"],
  "/reports/books/petty-cash": ["REPORTS.FINANCIAL", "VIEW"],
  "/reports/books/debit-credit-memo": ["REPORTS.FINANCIAL", "VIEW"],
